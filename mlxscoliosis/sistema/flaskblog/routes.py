...
def send_reset_email(user):
    ...
    msg.body = f'''Hola desde SpineX! si deseas cambiar tu contraseña sigue el sigueinte link:
{url_for('reset_token', token=token, _external=True)}

Ignora el mensaje en caso de que no desees hacer el cambio, no se hara ningun cambio.
'''
    mail.send(msg)
...
def upload():
    ...
    print("ESTO ES P1I",pi1)
    print("ESTO ES P12",pi2)
    #print("+++"*20)
    a, b = max_min(x, y)
    a_2 = a[1:3]
    b_2 = b[1:3]
